...
<head>
    ...
    <style>
        ...
        .success-msg { background: #E7F6EE; color: #1B7943; padding: 10px 15px; border-radius: 6px; max-width: 900px; margin: 0 auto 15px auto; }
        ...
        .user-avatar {
            width: 40px; height: 40px; border-radius: 50%; background: #F7FBFC;
